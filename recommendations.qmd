...
When a collection is consistent and OPeNDAP-supported, we should try using DMRPP metadata instead of reading metadata from source files—it’s faster and can represent various archival formats.
